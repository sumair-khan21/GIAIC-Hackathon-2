  ...
  return (
    <div className="min-h-screen flex w-full">
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-900 relative overflow-hidden items-center justify-center">
        <div className="absolute inset-0 bg-gradient-to-tr from-fuchsia-600/20 via-slate-900 to-violet-600/20" />
        ...
        <motion.div
          ...
          className="absolute top-1/4 right-1/4 w-96 h-96 bg-fuchsia-500/30 rounded-full blur-[100px]"
        />
        <motion.div
          animate={{ scale: [1, 1.3, 1], rotate: [0, 90, 0] }}
          transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
          className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-violet-500/30 rounded-full blur-[100px]"
        />
        ...
        <div className="relative z-10 text-center space-y-6 max-w-lg px-8">
          ...
          >
            Get started for free and join a community of productive individuals. No credit card required.
          </motion.p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background relative">
        <div className="w-full max-w-md space-y-8">
          ...
          >
            ...
            <p className="mt-2 text-slate-500">Sign up to start managing your tasks</p>
          </motion.div>
          ...
          <p className="text-center text-sm text-slate-500">
            ...
            <Link href="/auth/signin" className="text-violet-600 font-semibold hover:text-violet-500 hover:underline">
              Sign in
            </Link>
          </p>
        </div>

...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      {/* Floating Action Button (Mobile) - positioned above chat button */}
      <motion.button
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        ...
        whileTap={{ scale: 0.9 }}
        onClick={() => setIsModalOpen(true)}
        className="fixed bottom-24 right-6 sm:hidden w-14 h-14 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white rounded-full shadow-xl shadow-purple-500/30 flex items-center justify-center z-40"
      >
